...
class SWCFPC_Backend
{
    ...
    function admin_footer_text($footer_text) {
        ...
        $rate_us = '<a href="'.SWCFPC_PLUGIN_REVIEWS_URL.'?filter=5#new-post" rel="noopener noreferer" target="_blank">'
				. sprintf( __( 'Rate %s on %s', 'wp-cloudflare-page-cache' ), '<strong>' . __( 'WP Cloudflare Super Page Cache', 'wp-cloudflare-page-cache' ) . $stars . '</strong>', 'WordPress.org' )
			. '</a>' ;

        $forum = '<a href="'.SWCFPC_PLUGIN_FORUM_URL.'" target="_blank">' . __( 'Visit support forum', 'litespeed-cache' ) . '</a>' ;
