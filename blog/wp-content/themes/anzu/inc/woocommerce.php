...
add_action( 'after_setup_theme', 'anzu_woocommerce_support' );
if ( ! function_exists( 'anzu_woocommerce_support' ) ) {
	/**
	 * Declares WooCommerce theme support.
	 */
	function anzu_woocommerce_support() {
...
add_action( 'woocommerce_before_main_content', 'anzu_woocommerce_wrapper_start', 10 );
add_action( 'woocommerce_after_main_content', 'anzu_woocommerce_wrapper_end', 10 );

if ( ! function_exists( 'anzu_woocommerce_wrapper_start' ) ) {
	/**
	...
	function anzu_woocommerce_wrapper_start() {
		...
		echo '<div class="row">';
		get_template_part( 'views/global-templates/left-sidebar-check' );
		echo '<main class="site-main" id="main">';
	}
}

if ( ! function_exists( 'anzu_woocommerce_wrapper_end' ) ) {
	/**
	 * Display the theme specific end of the page wrapper.
	 */
	function anzu_woocommerce_wrapper_end() {
		echo '</main><!-- #main -->';
...
if ( ! function_exists( 'anzu_wc_form_field_args' ) ) {
	/**
	 ...
	 * @return mixed
	 */
	function anzu_wc_form_field_args( $args, $key, $value = null ) {
...
if ( ! function_exists( 'anzu_quantity_input_classes' ) ) {
	/**
	 ...
	 * @return array
	 */
	function anzu_quantity_input_classes( $classes ) {
