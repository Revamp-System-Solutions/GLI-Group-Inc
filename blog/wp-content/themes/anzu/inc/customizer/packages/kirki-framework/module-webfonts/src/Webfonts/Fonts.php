...
final class Fonts {
	...
	public static function get_all_variants() {
		return [
			'100'       => esc_html__( 'Ultra-Light 100', 'anzu' ),
			'100light'  => esc_html__( 'Ultra-Light 100', 'anzu' ),
			'100italic' => esc_html__( 'Ultra-Light 100 Italic', 'anzu' ),
			'200'       => esc_html__( 'Light 200', 'anzu' ),
			'200italic' => esc_html__( 'Light 200 Italic', 'anzu' ),
			'300'       => esc_html__( 'Book 300', 'anzu' ),
			'300italic' => esc_html__( 'Book 300 Italic', 'anzu' ),
			'400'       => esc_html__( 'Normal 400', 'anzu' ),
			'regular'   => esc_html__( 'Normal 400', 'anzu' ),
			'italic'    => esc_html__( 'Normal 400 Italic', 'anzu' ),
			'500'       => esc_html__( 'Medium 500', 'anzu' ),
			'500italic' => esc_html__( 'Medium 500 Italic', 'anzu' ),
			'600'       => esc_html__( 'Semi-Bold 600', 'anzu' ),
			'600bold'   => esc_html__( 'Semi-Bold 600', 'anzu' ),
			'600italic' => esc_html__( 'Semi-Bold 600 Italic', 'anzu' ),
			'700'       => esc_html__( 'Bold 700', 'anzu' ),
			'700italic' => esc_html__( 'Bold 700 Italic', 'anzu' ),
			'800'       => esc_html__( 'Extra-Bold 800', 'anzu' ),
			'800bold'   => esc_html__( 'Extra-Bold 800', 'anzu' ),
			'800italic' => esc_html__( 'Extra-Bold 800 Italic', 'anzu' ),
			'900'       => esc_html__( 'Ultra-Bold 900', 'anzu' ),
			'900bold'   => esc_html__( 'Ultra-Bold 900', 'anzu' ),
			'900italic' => esc_html__( 'Ultra-Bold 900 Italic', 'anzu' ),
		];
	}
