                        ...
                        <div class="col-sm-<?php echo esc_attr($integral['blog-layout']); ?> col-md-<?php echo esc_attr($integral['blog-layout']); ?> col-lg-<?php echo esc_attr($integral['blog-layout']); ?>">
                            <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
                                <div class="home-blog-entry-thumb">
                                    <a href="<?php the_permalink() ?>" rel="bookmark" title="<?php the_title_attribute(); ?>"><?php if(get_the_post_thumbnail()) { ?><figure class="post-image"><?php the_post_thumbnail('integral-home-post-thumbnails',array('class'=>'img-responsive img-rounded')); ?></figure><?php } ?></a>
                                </div>
                                ...
                                <div class="home-blog-entry-text">
                                    ...
                                    <p><?php echo wp_kses_post(integral_custom_excerpts(20)); ?></p>
                                </div>
                        </article>
                        </div>
                <?php endforeach; ?>
