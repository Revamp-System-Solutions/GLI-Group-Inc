...
$arilewp_footer_widgets_coloumn_layout = get_theme_mod('arilewp_footer_widgets_coloumn_layout', '4');
$arilewp_footer_widgets_coloumn_layout = 12/$arilewp_footer_widgets_coloumn_layout;
?>
...
if ( is_active_sidebar( 'footer-sidebar-one' ) ) : ?>
	<div class="col-lg-<?php echo esc_attr($arilewp_footer_widgets_coloumn_layout); ?> col-md-6 col-sm-12">
