...
function arilewp_frontpage_sections_scroll( section_id ){
    ...
    switch ( section_id ) {
        case 'accordion-section-arilewp_theme_top_header_area':
        scroll_section_id = "site-header";
        break;

        case 'aaccordion-section-arilewp_main_theme_slider':
        scroll_section_id = "theme-slider";
        break;

        case 'accordion-section-arilewp_theme_info_area':
        scroll_section_id = "theme-info-area";
        break;

        case 'accordion-section-arilewp_theme_service':
        scroll_section_id = "theme-services";
        break;

        case 'accordion-section-arilewp_theme_project':
        scroll_section_id = "theme-project";
        break;

        case 'accordion-section-arilewp_theme_funfact':
        scroll_section_id = "theme-funfact";
        break;

        case 'accordion-section-arilewp_theme_testimonial':
        scroll_section_id = "theme-testimonial";
        break;

        case 'accordion-section-arilewp_theme_wooshop':
        scroll_section_id = "theme-shop";
        break;

        case 'accordion-section-arilewp_theme_cta':
        scroll_section_id = "theme-cta";
        break;

        case 'accordion-section-arilewp_theme_team':
        scroll_section_id = "theme-team-mambers";
        break;
		
		case 'accordion-section-arilewp_theme_blog':
        scroll_section_id = "theme-blog";
        break;
		
		case 'accordion-section-arilewp_theme_client':
