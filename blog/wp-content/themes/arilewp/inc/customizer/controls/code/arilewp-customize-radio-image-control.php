...
/**
 * Class ArileWP_Customize_Radio_Image_Control
 */
class ArileWP_Customize_Radio_Image_Control extends ArileWP_Customize_Base_Control {
	 ...
	 * @var    string
	 */
	public $type = 'arilewp-radio-image';
