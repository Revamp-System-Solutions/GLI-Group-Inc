                      ...
                      <div class="w-full bg-gray-400 flex  border rounded justify-end">
                        ...
                        <input type="text" id="postsearch"  class="m-3 px-2 py-1 txt-sm rounded">
                            ...
                            <table class="table-fixed w-full border-collapse border border-gray-700 mt-2">
                                  <thead>
                                      <tr>
                                      <th class="w-1/4 border border-gray-600">Ratings</th>
                                      <th class="w-1/4 border border-gray-600">Client</th>
                                      <th class="w-1/4 border border-gray-600">Organization</th>
                                  ...
                                  <tbody v-if="posts.data.length > 0">
                                      <tr v-for="post in posts.data" :key="post.id" class="text-center ">
                                          ...
                                          <td class="border border-gray-600">
                                              <inertia-link :href="$route('testimonial.edit', {id: post.id})" class="btn btn-primary pull-right action-btn" v-if="user" ><i class="fas fa-edit"></i> Edit</inertia-link>
                                              <a href="javascript:void(0);" class="btn btn-warning pull-right action-btn" @click.prevent="openModal(post.id)" v-if="user"><i class="fas fa-trash-alt"></i> Delete</a>
                                          </td>
                                      </tr>
                                  </tbody>
                                  <tbody v-else>
