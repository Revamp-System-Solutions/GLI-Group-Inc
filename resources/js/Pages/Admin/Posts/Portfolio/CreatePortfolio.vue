                            ...
                            <div class="grid grid-cols-6 gap-6">
                                ...
                                <div class="col-span-6 ">
                                    ...
                                    <Listbox v-model="form.category" >
                                        <div class="relative">
                                            <ListboxButton v-slot="{open}" class="flex items-center justify-between z-30 relative w-full mt-1 p-3  text-left  border border-gray-300 bg-white rounded-md cursor-default focus:outline-none focus-visible:ring-2 focus-visible:ring-opacity-75 focus-visible:ring-white focus-visible:ring-offset-orange-300 focus-visible:ring-offset-2 focus-visible:border-green-500 sm:text-sm">
