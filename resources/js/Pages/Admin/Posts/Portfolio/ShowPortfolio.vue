      ...
      <div class="flex flex-col justify-center px-4">
          ...
          >
            <tr v-for="post in posts.data" :key="post.id">
              ...
              <td class="px-6 py-4 whitespace-nowrap space-x-1">
                <inertia-link
                  :href="$route('portfolio.edit', { slug: post.slug })"
                  class="text-sm text-white bg-blue-400 px-3 py-1 rounded-sm"
                  v-if="user"
                  ><i class="fas fa-edit"></i> Edit Post</inertia-link
                >
                <a
        ...
        >
          <ul class="pagination flex flex-row justify-between">
            ...
            <li
              :class="
                'page-item' + (posts.links[0].url == null ? ' disabled' : '')
              "
            >
              <inertia-link
                :href="posts.links[0].url == null ? '#' : posts.links[0].url"
                class="page-link"
            ...
            <li
              :class="
                'page-item' +
                (posts.links[posts.links.length - 1].url == null
                  ? ' disabled'
                  : '')
              "
            >
        ...
        <div class="min-h-screen px-4 text-center">
          ...
          >
            ...
            >
              ...
              >
                <i class="fas fa-trash-alt text-red-700"></i> Delete Portfolio:
                {{ targetPort.split("-").join(" ") }}
              </DialogTitle>
              <div class="mt-2">
                <p class="text-sm text-gray-500">
                  Are you sure you want to this portfolio? This action will not
                  affect Media used.
                </p>
              </div>
...
export default {
  ...
  setup() {
    ...
    const numberLinks = posts.value.links.filter(
      (v, i) => i > 0 && i < posts.value.links.length - 1
    );
