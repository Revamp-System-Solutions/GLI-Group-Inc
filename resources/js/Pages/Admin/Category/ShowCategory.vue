              ...
              <div class="flex flex-col justify-center px-4" >
                <div class="w-full bg-gray-400 flex  border rounded justify-end">
                  ...
                  <input type="text" id="postsearch"  class="m-3 px-2 py-1 txt-sm rounded">
                      ...
                      <nav aria-label="Page navigation" v-if="categories.total > categories.per_page" style="margin-top: 20px" class="w-1/5 mx-auto">
  ...
  <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
    ...
    <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
      ...
      <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
        <button type="button" class="w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-red-600 text-base font-medium text-white hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 sm:ml-3 sm:w-auto sm:text-sm" @click.prevent="modalOpen=false;deleteCategory(target)">
          Delete
        </button>
