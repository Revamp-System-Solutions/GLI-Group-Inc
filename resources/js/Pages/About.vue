                ...
                <div class=" lg:py-36 lg:my-12 static">
                    <div class="rvmp-bg-main bg-opacity-70 lg:absolute lg:top-0 xl:pr-32 lg:pr-28 lg:py-16 lg:my-20  lg:w-7/12  w-full ">  
                       <blockquote className="self-start border-l-8 my-2">
                            ...
                            <h2 class="ml-5 brand-logo-bold text-3xl font-semibold">GLI <span class="brand-logo-light font-thin rvmp-brand-color-highlight">GROUP INC.</span></h2> 
                        </blockquote>
            ...
            <div class="flex lg:flex-row flex-col  bg-cover bg-no-repeat bg-top bg-local " style="background-image: url('/images/pages/house.jpg')" >
                <div class="w-full relative py-10 h-auto rvmp-brand-bg-main bg-opacity-70" >
                    <div class="py-4 h-72 text-center mt-auto w-full flex flex-col justify-center rvmp-text-alt bg-transparent">
                        <h2 class="brand-text-content lg:text-3xl text-xl font-light ">We Build as One here in</h2>
                        <h2 class="brand-logo-bold lg:text-4xl text-2xl font-bold py-2">GLI <span class="brand-logo-light font-thin">GROUP INC.</span></h2>    
                    </div> 
                </div>
            </div>
    </div>
