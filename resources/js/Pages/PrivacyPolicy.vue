        ...
        <div class="w-full bg-origin-border bg-cover bg-center bg-local" style="background-image: url('/images/pages/house.jpg')">
            <div class="h-40 mx-auto 2xl:px-40 xl:px-16 px-8 flex lg:flex-wrap lg:content-center justify-center rvmp-banner-bg bg-opacity-80">
                <div class="lg:w-full lg:self-start self-center">
                    <h1 class="px-5 brand-text xl:text-3xl text-xl font-bold rvmp-banner-text-color capitalize">Privacy Policy</h1>
                </div>
            </div>
        </div>
            ...
            <div class="flex flex-col h-auto ">
                <div class="w-full  h-auto lg:py-20 lg:pl-10 lg:pr-0 p-6 ">            
                        <div class="w-full h-full grid grid-cols-1 place-content-center gap-y-4">  
                            ...
                            <span class="block">We collect personal information that you voluntarily provide to us when you express an interest in obtaining information about us or our products and services, when you participate in activities on the Website or otherwise when you contact us.</span>
                            <span class="block"> The personal information that we collect depends on the contect of your interactions with us and the Website, the choices you make and the products and features you use. The personal information we collect may include the following:</span>
                            <span class="block"><span class="font-semibold">Personal Information Provided by You.</span> We collect names; email addresses; contact or authentication data; company names; and other similar information.</span>
                           <span class="block"> All personal information that you provide to us must be true, complete and accuratem and you must notify us of any changes to such personal information.</span>
                            ...
                            <p class="col-span-1 font-light text-gray-500 text-justify lg:text-sm text-xs brand-text sapce-y-2">
                              <span class="block">We use personal information collected via our Website for a variety of business purposes described below. We process your personal information for these purposes in reliance on our legitimate business interests, in order to enter into or perform a contract with you, with your consent, and/or for compliance with our legal obligations. We indicate the specific processing grounds we rely on next to each purpose listed below.</span> 
